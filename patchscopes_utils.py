    ...
    def post_hook(module, input, output):
      ...
      for position_, hs_ in position_hs:
        if "skip_ln" in name:
          ...
          # see https://www.copilot.com/chats/jpGFd1taCx4pzSMX4VfmA
          output[0][position_] = hs_
    ...
    def post_hook(module, input, output):
      ...
      for position_, hs_ in position_hs:
        if "skip_ln" in name or "mlp" in name:
          ...
          # output[0][0, position_] = hs_ # see https://copilot.microsoft.com/chats/jpGFd1taCx4pzSMX4VfmA
          output[0][position_] = hs_
...
def set_hs_patch_hooks_phi(
  ...
  for i in hs_patch_config:
    ...
    if patch_input:
      ...
      if skip_final_ln and i == len(model.model.layers) - 1 and module == "hs":
        hooks.append(
            model.model.final_layernorm.register_forward_hook(
                patch_hs(
                    f"patch_hs_{i}_skip_ln",
                    hs_patch_config[i],
                    patch_input,
